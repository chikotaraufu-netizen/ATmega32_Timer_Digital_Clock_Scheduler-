...
These tests verify that the Timer1 CTC configuration produces an accurate 1 Hz tick and the clock counts correctly.
...
|----|----------|-------------|------------|
| KI-1 | Low | Clock drifts ~16s/day due to prescaler 1024 rounding | Use prescaler 256 or software compensation |
